                    ...
                    <nav class="level is-mobile ">
                        ...
                        <div class="level-item has-text-centered">
                            <div>
                                ...
                                <p class="title" id="targetId">789</p>
                            </div>
                        </div>
                    </nav>
                </div>
...
<div class="columns is-vcentered has-background-warning ">
    <div class="column box auto">
        <div
            class=" has-text-centered has-text-weight-ligh is-family-monospace is-italic "
        >
            ...
            <li>
                ...
                <code
                    >Mount & Blade: With Fire & Sword/Modules/Mercenaries</code
                >
            </li>
            <li>
