...
class WarbandController extends Controller
{
    public function checkplayer(Request $request)
    {
        ...
        if ($user == null) {
            ...
            $helmet = $user->getHead()->ItemData->game_id ?? 1021;
            $armor = $user->getBody()->ItemData->game_id ?? 969;
            ...
            $weapon_1 = $user->getWeapon1()->ItemData->game_id ?? 428;
            $weapon_2 = $user->getWeapon2()->ItemData->game_id ?? 1048;
            $weapon_3 = $user->getWeapon3()->ItemData->game_id ?? 1023;
            $weapon_4 = $user->getWeapon4()->ItemData->game_id ?? 1046;
            // }
